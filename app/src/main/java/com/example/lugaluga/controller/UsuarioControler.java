...
public class UsuarioControler {
    ...
    public UsuarioControler(Context context){
        banco = new CriarBanco(context);
    }
    public String insereDados(String nome,String cpf, String dataNasc,String cep,
                              String municipio,String logradouro,int numero,String complemento,
                              String bairro,int telefone,String email,String senha){
        ...
        valores.put(CriarBanco.TELEFONE,email);
        ...
        if (resultado == -1){
            return "Erro ao insetir o registro";
        }
